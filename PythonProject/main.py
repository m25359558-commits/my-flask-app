...
STUDENT_DB = {
    ...
    "m25359558@gmail.com": {
        ...
        "warning": {
            "title": "Баллы за дисциплины/Контроли / Транскрипт",
            "note": "Внимание!",
        ...
        "overdrawing": [
            {"name": "Базовый иностранный язык", "code": "BI B01", "credits": 4, "rk1": "-", "rk2": "-", "exam": "-", "total_score": "74", "gpa": "2.33"},
            {"name": "Базовый иностранный язык в контексте межкультурной коммуникации", "code": "BIYaKMK B01", "credits": 4, "rk1": "-", "rk2": "-", "exam": "-", "total_score": "69", "gpa": "2.00"},
            {"name": "Введение в языкознание", "code": "VYa B01", "credits": 5, "rk1": "-", "rk2": "-", "exam": "-", "total_score": "87", "gpa": "3.33"},
            {"name": "Второй иностранный язык", "code": "VIYa B01", "credits": 5, "rk1": "-", "rk2": "-", "exam": "-", "total_score": "94", "gpa": "3.67"},
            {"name": "Второй иностранный язык - I", "code": "VIYa(I) B01", "credits": 4, "rk1": "-", "rk2": "-", "exam": "-", "total_score": "89", "gpa": "3.33"},
            {"name": "Второй иностранный язык - III", "code": "VIYa(III) B01", "credits": 5, "rk1": "-", "rk2": "-", "exam": "-", "total_score": "94", "gpa": "3.67"},
            {"name": "Иностранный язык - I", "code": "IYa(I) B01", "credits": 5, "rk1": "-", "rk2": "-", "exam": "-", "total_score": "71", "gpa": "2.33"},
            {"name": "Иностранный язык - II", "code": "IYa(II) B01", "credits": 5, "rk1": "-", "rk2": "-", "exam": "-", "total_score": "75", "gpa": "2.67"},
...
TEACHER_DB = {
    ...
    "38187@turaaaaaaaaaan-edu.kz": {
        "role": "teacher",
        "personal_info": {
            "ID_Teacher": "4",
            "full_name": "Иванов  Иванович",
            "work": "Депортамент по академическим вопросам/ директор",
            "iin": "1002=0-0-900989880030",
            "email": "30938888187@turan-edu.kz",
            "mob_phone": "+7(777)123-45-67",
            "work_phone": "+7(727)260-40-07",
            "work_phone2": "10000000000000000000000",
            "body": "павильон №21/UN 301",
            "Birthday": "Мужской/10 октября"
        },
        "professional_info": {
            "status": "работает",
